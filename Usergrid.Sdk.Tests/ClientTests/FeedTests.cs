...
namespace Usergrid.Sdk.Tests.ClientTests
{
    ...
    public class FeedTests
    {
        ...
        {
            var usergridActivities = new UsergridCollection<UsergridEntity<UsergridActivity>>();
            _entityManager.GetEntities<UsergridActivity>("/groups/groupIdentifier/feed").Returns(usergridActivities);

            UsergridCollection<UsergridEntity<UsergridActivity>> returnedActivities = _client.GetGroupFeed<UsergridActivity>("groupIdentifier");
        ...
        public void GetUserFeedShouldDelegateToEntityManagerWithCorrectEndpoint()
        {
            ...
            UsergridCollection<UsergridEntity<UsergridActivity>> returnedActivities = _client.GetUserFeed<UsergridActivity>("userIdentifier");
